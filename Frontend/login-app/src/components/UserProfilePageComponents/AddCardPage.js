...
const AddCardPage = ({ onSave, onCancel }) => {
  ...
  return (
    <div className="bg-white shadow rounded-lg p-6 h-full">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-800">Añadir Tarjeta</h2>
        <button
          onClick={onCancel}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="mb-6">
          <div className={`h-48 w-full rounded-xl p-5 ${
            cardData.type === 'Visa' ? 'bg-gradient-to-r from-blue-500 to-blue-700' : 
            cardData.type === 'Mastercard' ? 'bg-gradient-to-r from-red-500 to-yellow-500' : 
