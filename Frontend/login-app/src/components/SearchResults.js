          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="divide-y divide-gray-200">
              {searchResults.map(book => (
                <div key={book.id} className="p-4 hover:bg-gray-50 flex flex-col md:flex-row">
                  {/* Imagen del libro */}
                  ...
                  <div className="md:w-1/6 flex flex-col items-center justify-center mt-4 md:mt-0">
                    ...
                    <div className="space-y-2 w-full">
                      ...
                      <button className="w-full bg-gray-200 text-gray-800 px-4 py-2 rounded hover:bg-gray-300 transition-colors text-sm">
                        Ver detalles
                      </button>
                    </div>
                  </div>
